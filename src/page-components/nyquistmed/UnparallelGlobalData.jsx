  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-25 bg-white">
      ...
      <motion.div 
        ...
        className="max-w-[1222px] mx-auto px-4 sm:px-6 lg:px-8 mb-16"
      >
        <motion.div variants={itemVariants} className="text-center mb-8">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-8">
            {nyquistMedData.flags.title}
          </h2>
        </motion.div>
        <motion.div 
        ...
        >
          {nyquistMedData.flags.countries.map((country) => (
            <motion.div 
              key={country.id} 
              variants={itemVariants}
      ...
      >
        {nyquistMedData.globalDataSections.map((section, index) => (
          <motion.div 
            key={section.id} 
            variants={itemVariants}
