...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1250px] sm:mt-[-13px] mx-auto z-10 flex items-center justif-start h-full px-4 sm:px-6 md:px-8">
        <div className="text-left w-full">
          ...
          >
            <a 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white !text-center px-6 sm:px-8 py-3 rounded-full font-semibold cursor-pointer group hover:translate-y-[-2px] transition-transform duration-300 text-sm sm:text-base inline-block"
            >
              SCHEDULE A DEMO
            </a>
            <button 
              onClick={() => setIsVideoModalOpen(true)}
              className="bg-white hover:bg-gray-100 text-black px-6 sm:px-8 py-3 rounded-full font-semibold cursor-pointer group hover:translate-y-[-2px] transition-transform duration-300 flex items-center justify-center gap-2 text-sm sm:text-base"
            >
