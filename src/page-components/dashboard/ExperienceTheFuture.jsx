    ...
    <section className="py-16 sm:py-20 md:py-25 bg-white">
      <div className="max-w-[1250px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="text-center">
          {/* Main Title */}
          <div className="text-[32px] sm:text-[40px] md:text-[50px] lg:text-[50px] font-medium  capitalize leading-[1.2em] text-black mb-4 sm:mb-10 md:mb-12">
            {experienceTheFuture.title}
          </div>

          {/* Subtitle */}
          <div className="text-[14px] sm:text-[16px] md:text-[18px] font-normal text-black mb-3 sm:mb-4 md:mb-[28px]">
